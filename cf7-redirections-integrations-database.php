...
if ( ! class_exists( 'CF7_Integrated' ) ) {

    class CF7_Integrated {
        ...
        private function add_modules() {
            ...
            require_once plugin_dir_path( __FILE__ ) . 'modules/integromat/class-module-integromat.php';

            // Instantiate the Module's classes:
            $this->modules['cf7'] = new CFTZ_Module_CF7( $this );
            $this->modules['integromat'] = new CFTZ_Module_Integromat( $this );
        }
